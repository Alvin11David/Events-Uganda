                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: LinearGradient(
                              ...
                              stops: [0.0, 0.47],
                              colors: [Color(0XFFE0E7FF), Color(0xFFCC471B)],
                            ),
                          ),
                          child: Material(
...
class _ResponsiveTextField extends StatefulWidget {
  ...
  @override
  State<_ResponsiveTextField> createState() => _ResponsiveTextFieldState();
}

class _ResponsiveTextFieldState extends State<_ResponsiveTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: TextField(
        ...
        style: TextStyle(
          fontSize: widget.fontSize ?? screenWidth * 0.045,
          color: Colors.black,
        ),
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(
            widget.icon,
            color: widget.iconColor ?? const Color.fromARGB(255, 0, 0, 0),
          ),
